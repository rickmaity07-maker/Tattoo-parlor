...
export default function MultiStepBooking() {
  return (
    <section id="reserve" data-bg="cta" className="snap-section z-10 w-full px-6">
      <div className="mx-auto flex w-full max-w-4xl flex-col items-center">
        ...
        >
          <div className="grid md:grid-cols-5">
            <div className="flex flex-col justify-center border-b border-void/10 p-8 text-center md:col-span-2 md:border-b-0 md:border-r md:p-10 md:text-left">
              <p className="text-[11px] uppercase tracking-[0.3em] text-rose">Reserve</p>
              <h2 className="mt-3 font-display text-3xl font-medium tracking-tight md:text-4xl">
                Book the chair.
              </h2>
              <p className="mt-4 text-sm leading-relaxed text-void/65">
