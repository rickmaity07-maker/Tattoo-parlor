            ...
            >
              <div className="grid gap-4 sm:grid-cols-2 sm:gap-5">
                <div>
                  ...
                  <input type="text" required className="min-h-[44px] w-full border-b border-void/20 bg-transparent py-2.5 text-base outline-none focus:border-rose" placeholder="Full name" />
                </div>
                <div>
                  <label className="mb-1 block text-[10px] uppercase tracking-widest text-void/40">Email</label>
                  <input type="email" required className="min-h-[44px] w-full border-b border-void/20 bg-transparent py-2.5 text-base outline-none focus:border-rose" placeholder="you@email.com" />
                </div>
              </div>
              <div>
                <label className="mb-1 block text-[10px] uppercase tracking-widest text-void/40">Preferred artist</label>
                <select className="min-h-[44px] w-full border-b border-void/20 bg-transparent py-2.5 text-base outline-none focus:border-rose">
              ...
              <div>
                ...
                <textarea rows={3} required className="w-full resize-none border-b border-void/20 bg-transparent py-2.5 text-base outline-none focus:border-rose" placeholder="Placement, size, style…" />
              </div>
              <button type="submit" className="min-h-[48px] w-full rounded-full bg-void py-3.5 text-[11px] font-medium uppercase tracking-[0.25em] text-parchment transition active:bg-void/90">
